...
"use strict";
let greet=() =>{               // → inherits from top-level → window
    console.log(this);
}

greet();

let meet = function(){     //iske pass apna this hota hai but in stict mode its undefined deta hai
    console.log(this);
}

meet(); //window.meet() nhi likh skte kyuki let global obj ka part nhi hai 
